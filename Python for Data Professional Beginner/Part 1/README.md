Pada bagian ini, Anda akan mempelajari apa itu bahasa pemograman Python. Dan praktek langsung bagaimana cara mencetak "Hello World", dan mengenal struktur bahasa pemograman Python.
